...
useEffect(() => { console.log($$(text1)) })
useEffect(() => { console.log($$(text2)) })
        ...
        <div class='pt-[60px]'>
            ...
            <div class='[@media(min-width:768px)]:w-[750px] mx-auto px-[15px]'>
                ...
                <div class={row}>
                    ...
                    <TextField class='inline-block w-[27.33%] mt-[20px] mr-3' effect={[preset.effect2, 'w-full']} placeholder={'effect2'} value={text2} reactive />
