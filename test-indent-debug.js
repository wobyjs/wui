#!/usr/bin/env node
/**
 * Test: Full sequence with detailed indent debugging
 */
...
async function runTest() {
    ...
    ws.on('open', async () => {
        ...
        const selCheck = await sendCommand(ws, 'Runtime.evaluate', {
            expression: `
            (function() {
        ...
        console.log('Selection before indent:', JSON.stringify(selCheck.result.value, null, 2));
        ...
        console.log('\n=== After indent ===');
        console.log('HTML:', html.substring(0, 400));

        // Check if indent was applied
        const hasMargin = html.includes('margin-left');
        console.log('\nHas margin-left:', hasMargin);
