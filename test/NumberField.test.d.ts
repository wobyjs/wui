declare const DefaultNumberField: () => import("woby").Child;
declare const ValueNumberField: () => import("woby").Child;
declare const MinMaxNumberField: () => import("woby").Child;
declare const StepNumberField: () => import("woby").Child;
