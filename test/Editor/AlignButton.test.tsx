    ...
    return <>
        <EditorContext.Provider value={editorRef}>
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-4 items-center my-2 border border-gray-300 rounded p-4">
                    <AlignButton mode="left" class="text-black" />
                    <AlignButton mode="center" class="text-black" />
                    <AlignButton mode="right" class="text-black" />
                    <AlignButton mode="justify" class="text-black" />
                </div>
