declare const DefaultBadge: () => import("woby").Child;
declare const BadgeTopRight: () => import("woby").Child;
declare const BadgeTopLeft: () => import("woby").Child;
declare const BadgeBottomRight: () => import("woby").Child;
