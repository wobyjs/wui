declare const BasicZoomable: () => import("woby").Child;
declare const ZoomableWithCustomScale: () => import("woby").Child;
declare const ZoomableWithCustomSize: () => import("woby").Child;
