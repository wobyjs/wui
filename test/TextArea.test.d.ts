declare const BorderEffectTextArea: () => import("woby").Child;
declare const FillEffects: () => import("woby").Child;
declare const LabelEffects: () => import("woby").Child;
declare const AlternativeEffects: () => import("woby").Child;
declare const ResizeableBorderEffects: () => import("woby").Child;
