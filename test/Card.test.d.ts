declare const VariantCardExample: () => import("woby").Child;
declare const OutlinedCardExample: () => import("woby").Child;
declare const FilledCardExample: () => import("woby").Child;
declare const MediaCenteredCardExample: () => import("woby").Child;
declare const ActionsAlignedCardExample: () => import("woby").Child;
