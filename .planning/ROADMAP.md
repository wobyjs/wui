...
Plans:
- [ ] 01-01-PLAN.md — SelectionManager and BrowserCompat modules with path-based tracking
- [ ] 01-02-PLAN.md — DOMNormalizer and StyleEngine with merge/unwrap/clean operations
- [ ] 01-03-PLAN.md — UndoRedo enhancement, Editor integration, test suites
